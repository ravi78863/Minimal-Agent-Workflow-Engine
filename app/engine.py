...
class WorkflowEngine:
    ...
    - Nodes are functions (via tools)
    - State is a dict flowing through
    - Edges + branching via NodeConfig.next + Condition
    - Looping via edges pointing backward + conditions
    """
